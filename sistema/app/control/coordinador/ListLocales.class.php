...
class ListLocales extends TPage
{
    ...
    */
    public function __construct()
    {
        ...
        $column_direccion = new TDataGridColumn('direccion', 'DirecciÃ³n', 'left');
        ...
        $column_mesas = new TDataGridColumn('mesas', 'NÂº Mesas', 'right');
        ...
        $column_electores = new TDataGridColumn('electores', 'NÂº Electores', 'right');
