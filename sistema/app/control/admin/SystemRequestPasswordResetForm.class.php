...
class SystemRequestPasswordResetForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $this->form->setFormTitle( 'Restablecer contraseña' );
        ...
        try
        {
            ...
            if ($user instanceof SystemUser)
            {
                ...
                else
                {
                    ...
                    new TMessage('info', 'Se ha enviado a su correo <b>'.$user->email.'</b> los pasos para reestablecer su nueva contraseña. Recuerde que tiene 1 hora para poder cambiar su contraseña, de lo contrario el link expirará y tendrá que solicitarlo nuevamente');
                }
            }
            else
            {
