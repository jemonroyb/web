...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btn->style = 'height: 40px;width: 90%;display: block;margin: auto;font-size:17px; background-color: #D41D1D !important; border-color: #E41138 !important;';
