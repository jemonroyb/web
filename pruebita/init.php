...
if (version_compare(PHP_VERSION, '5.4.0') == -1)
{
 ...
 define('PLANTILLA_FRONT', 'front1');
 define('NOTICIAS', 'sala-de-prensa');
 define('PROPUESTAS', 'propuestas');
 define('PLATAFORMA', 'plataforma-del-frente');
 define('ACTIVISMO', 'activismo');
 define('CONOCEME', 'conoceme');
