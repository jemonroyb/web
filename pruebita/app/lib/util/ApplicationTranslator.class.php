...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['pt'][] = 'Recuperar';
                ...
                $this->messages['es'][] = 'Arquivo não encontrado';
        $this->messages['es'][] = 'Buscar';
        $this->messages['es'][] = 'Cadastrar';
        $this->messages['es'][] = 'Registro salvo';
        $this->messages['es'][] = 'Deseja realmente excluir ?';
        $this->messages['es'][] = 'Registro excluído';
        $this->messages['es'][] = 'Função';
        $this->messages['es'][] = 'Tabela';
        $this->messages['es'][] = 'Ferramenta';
        $this->messages['es'][] = 'Dados';
        $this->messages['es'][] = 'Abrir';
        $this->messages['es'][] = 'Novo';
        $this->messages['es'][] = 'Salvar';
        $this->messages['es'][] = 'Buscar';
        $this->messages['es'][] = 'Editar';
        $this->messages['es'][] = 'Excluir';
        $this->messages['es'][] = 'Cancelar';
        $this->messages['es'][] = 'Sim';
        $this->messages['es'][] = 'Não';
        $this->messages['es'][] = 'Janeiro';
        $this->messages['es'][] = 'Fevereiro';
        $this->messages['es'][] = 'Março';
        $this->messages['es'][] = 'Abril';
        $this->messages['es'][] = 'Maio';
        $this->messages['es'][] = 'Junho';
        $this->messages['es'][] = 'Julho';
        $this->messages['es'][] = 'Agosto';
        $this->messages['es'][] = 'Setembro';
        $this->messages['es'][] = 'Outubro';
        $this->messages['es'][] = 'Novembro';
        $this->messages['es'][] = 'Dezembro';
        $this->messages['es'][] = 'Hoje';
        $this->messages['es'][] = 'Fechar';
        $this->messages['es'][] = 'O campo ^1 não pode ter menos de ^2 caracteres';
        $this->messages['es'][] = 'O campo ^1 não pode ter mais de ^2 caracteres';
        $this->messages['es'][] = 'O campo ^1 não pode ser menor que ^2';
        $this->messages['es'][] = 'O campo ^1 não pode ser maior que ^2';
        $this->messages['es'][] = 'O campo ^1 é obrigatório';
        $this->messages['es'][] = 'O campo ^1 não contém um CNPJ válido';
        $this->messages['es'][] = 'O campo ^1 não contém um CPF válido';
        $this->messages['es'][] = 'O campo ^1 contém um e-mail inválido';
        $this->messages['es'][] = 'Permissão negada';
        $this->messages['es'][] = 'Gerar';
        $this->messages['es'][] = 'Listar';
        $this->messages['es'][] = 'Senha errada';
        $this->messages['es'][] = 'Usuário não encontrado';
        $this->messages['es'][] = 'Usuário';
        $this->messages['es'][] = 'Usuários';
        $this->messages['es'][] = 'Senha';
        $this->messages['es'][] = 'Login';
        $this->messages['es'][] = 'Nome';
        $this->messages['es'][] = 'Grupo';
        $this->messages['es'][] = 'Grupos';
        $this->messages['es'][] = 'Programa';
        $this->messages['es'][] = 'Programas';
        $this->messages['es'][] = 'Voltar para a listagem';
        $this->messages['es'][] = 'Classe de controle';
        $this->messages['es'][] = 'Email';
        $this->messages['es'][] = 'Registro atualizado';
        $this->messages['es'][] = 'Confirma senha';
        $this->messages['es'][] = 'Tela inicial';
        $this->messages['es'][] = 'Nome da Tela';
        $this->messages['es'][] = 'As senhas não conferem';
        $this->messages['es'][] = 'Entrar';
        $this->messages['es'][] = 'Data';
        $this->messages['es'][] = 'Coluna';
        $this->messages['es'][] = 'Operação';
        $this->messages['es'][] = 'Valor antigo';
        $this->messages['es'][] = 'Valor novo';
        $this->messages['es'][] = 'Database';
        $this->messages['es'][] = 'Profile';
        $this->messages['es'][] = 'Mudar senha';
        $this->messages['es'][] = 'Deixe vazio para manter a senha anterior';
        $this->messages['es'][] = 'Resultados';
        $this->messages['es'][] = 'Comando inválido';
        $this->messages['es'][] = '^1 registros exibidos';
        $this->messages['es'][] = 'Administração';
        $this->messages['es'][] = 'Painel SQL';
        $this->messages['es'][] = 'Log de acesso';
        $this->messages['es'][] = 'Log de alterações';
        $this->messages['es'][] = 'Log de SQL';
        $this->messages['es'][] = 'Limpar formulário';
        $this->messages['es'][] = 'Enviar';
        $this->messages['es'][] = 'Mensagem';
        $this->messages['es'][] = 'Assunto';
        $this->messages['es'][] = 'Mensagem enviada com sucesso';
        $this->messages['es'][] = 'Marcar como lida';
        $this->messages['es'][] = 'Marcar como não lida';
        $this->messages['es'][] = 'Ação';
        $this->messages['es'][] = 'Ler';
        $this->messages['es'][] = 'Origem';
        $this->messages['es'][] = 'Verificado';
        $this->messages['es'][] = 'Objeto ^1 não encontrado em ^2';
        $this->messages['es'][] = 'Notificação';
        $this->messages['es'][] = 'Categorias';
        $this->messages['es'][] = 'Enviar documentos';
        $this->messages['es'][] = 'Meus documentos';
        $this->messages['es'][] = 'Compartilhados comigo';
        $this->messages['es'][] = 'Documento';
        $this->messages['es'][] = 'Arquivo';
        $this->messages['es'][] = 'Título';
        $this->messages['es'][] = 'Descrição';
        $this->messages['es'][] = 'Categoria';
        $this->messages['es'][] = 'Data de submissão';
        $this->messages['es'][] = 'Data de arquivamento';
        $this->messages['es'][] = 'Upload';
        $this->messages['es'][] = 'Download';
        $this->messages['es'][] = 'Próximo';
        $this->messages['es'][] = 'Documentos';
        $this->messages['es'][] = 'Permissão';
        $this->messages['es'][] = 'Unidade';
        $this->messages['es'][] = 'Unidades';
        $this->messages['es'][] = 'Adiciona';
        $this->messages['es'][] = 'Ativo';
        $this->messages['es'][] = 'Ativar/desativar';
        $this->messages['es'][] = 'Usuário inativo';
        $this->messages['es'][] = 'Envia mensagem';
        $this->messages['es'][] = 'Um usuário já está cadastrado com este login';
        $this->messages['es'][] = 'Estatísticas de acesso';
        $this->messages['es'][] = 'Acessos';
        $this->messages['es'][] = 'Preferências';
        $this->messages['es'][] = 'E-mail de origem';
        $this->messages['es'][] = 'Autentica SMTP';
        $this->messages['es'][] = 'Host SMTP';
        $this->messages['es'][] = 'Porta SMTP';
        $this->messages['es'][] = 'Usuário SMTP';
        $this->messages['es'][] = 'Senha SMTP';
        $this->messages['es'][] = 'Ticket';
        $this->messages['es'][] = 'Abrir ticket';
        $this->messages['es'][] = 'Email de suporte';
        $this->messages['es'][] = 'Dia';
        $this->messages['es'][] = 'Pastas';
        $this->messages['es'][] = 'Compor';
        $this->messages['es'][] = 'Entrada';
        $this->messages['es'][] = 'Enviados';
        $this->messages['es'][] = 'Arquivados';
        $this->messages['es'][] = 'Arquivar';
