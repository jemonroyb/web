...
class WebMessageList extends TStandardList
{
    ...
    public function filterInbox($param)
    {
        ...
        TSession::setValue('Web_inbox_criteria', $criteria);
        TSession::setValue('Web_inbox_criteria_type', 'inbox');
    ...
    public function filterArchived($param)
    {
        ...
        $criteria->add(new TFilter('checked', '=', 'Y' ) );
        TSession::setValue('Web_inbox_criteria', $criteria);
        TSession::setValue('Web_inbox_criteria_type', 'archived');
        parent::setCriteria( $criteria ); // define a standard filter
    ...
    public function filterSent($param)
    {
        $criteria = new TCriteria;
        TSession::setValue('Web_inbox_criteria', $criteria);
        TSession::setValue('Web_inbox_criteria_type', 'sent');
