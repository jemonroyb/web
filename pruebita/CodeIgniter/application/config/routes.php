...
$route[NOTICIAS] = 'Welcome/dia_a_dia';
$route[NOTICIAS.'/(:any)'] = 'Welcome/dia_a_dia/$1';
$route[PROPUESTAS] = 'Welcome/propuestas';
$route[PROPUESTAS.'/(:any)'] = 'Welcome/propuestas/$1';
$route[PLATAFORMA] = 'Welcome/plataforma';
$route[PLATAFORMA.'/(:any)'] = 'Welcome/plataforma/$1';
$route[ACTIVISMO] = 'Welcome/activismo';
